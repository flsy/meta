...
export const camelize = (strings: string[]) => strings.map((s, index) => (index === 0) ? s : capitalize(s)).join('')
...
// export const toTree = (arr: ITable[]): InternalStructure => arr.reduce(getNested, {})
